...
const translations = {
  en: {
    ...
    "card.currents.description": "Bidirectional ADC measurements after the DRV8323 current-sense amplifiers.",
    ...
    "card.temperature.description": "Board NTC and STM32 die temperature from ADC1 TS.",
    "card.temperature.pcb": "PCB NTC",
    "card.temperature.mcu": "MCU die",
    "card.temperature.series": "PCB NTC",
  ...
  tr: {
    ...
    "card.currents.description": "DRV8323 akım algılama yükselteçlerinden sonraki çift yönlü ADC ölçümleri.",
    ...
    "card.temperature.description": "Kart NTC ve STM32 çekirdek sıcaklığı (ADC1 TS).",
    "card.temperature.pcb": "PCB NTC",
    "card.temperature.mcu": "MCU çekirdek",
    "card.temperature.series": "PCB NTC",
