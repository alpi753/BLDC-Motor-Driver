...
const translations = {
  en: {
    ...
    "card.temperature.description": "MOSFET NTC temperature and PCB estimate from the STM32 internal sensor.",
  ...
  tr: {
    ...
    "card.temperature.description": "MOSFET NTC sıcaklığı ve STM32 dahili sensöründen kart sıcaklığı tahmini.",
    "card.temperature.mosfet": "MOSFET",
    "card.temperature.pcb": "PCB",
    "card.temperature.series": "MOSFET",
