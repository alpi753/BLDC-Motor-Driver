...
const translations = {
  en: {
    ...
    "card.phaseB": "Phase B",
    "card.phaseC": "Phase C",
    "card.temperature.title": "PCB temperature",
    "card.temperature.description": "Live reading from the board's 10 kΩ NTC thermistor.",
  ...
  tr: {
    ...
    "card.phaseB": "Faz B",
    "card.phaseC": "Faz C",
    "card.temperature.title": "PCB sıcaklığı",
    "card.temperature.description": "Kartın 10 kΩ NTC termistöründen canlı ölçüm.",
    "card.temperature.series": "PCB NTC",
