...
const translations = {
  en: {
    ...
    "card.currents.description": "ADC measurements after the DRV8323 current-sense amplifiers.",
  ...
  tr: {
    ...
    "card.currents.description": "DRV8323 akım algılama yükselteçlerinden sonraki ADC ölçümleri.",
